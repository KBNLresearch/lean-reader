...
import type { ReadiumSpeechPlaybackEvent, ReadiumSpeechPlaybackState } from "../navigator";
import type { ReadiumSpeechUtterance } from "../utterance";
...
import { detectFeatures, type WebSpeechFeatures } from "../utils/features";
import { detectPlatformFeatures, type WebSpeechPlatformPatches } from "../utils/patches";
...
export class WebSpeechEngine implements ReadiumSpeechPlaybackEngine {
  ...
  pause(): void {
    if (this.playbackState === "playing") {
      ...
      console.log("Is Android? ", this.patches.isAndroid)
